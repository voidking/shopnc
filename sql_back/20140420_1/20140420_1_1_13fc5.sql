...
) ENGINE=MyISAM AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='商品评价统计表';
...
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='店铺评价统计表';
...
CREATE TABLE `shopnc_gold_log` (
  ...
  PRIMARY KEY (`glog_id`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='金币日志表';
...
CREATE TABLE `shopnc_points_log` (
  ...
  PRIMARY KEY (`pl_id`)
) ENGINE=MyISAM AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='会员积分日志表';
...
CREATE TABLE `shopnc_predeposit_recharge` (
  ...
  PRIMARY KEY (`pdr_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='预存款充值信息表';
