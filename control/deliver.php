...
//发送短信开始（MR.PPX）-----------卖家点击发货给买家发短信-----------------------------------------------------------------
   ...
   $order = Model('order');  
        ...
        $mj_name=$order_info[buyer_name]; 
        $sj_name=$order_info[store_name];  
...
$message_mj=$GLOBALS['setting_config']['mjfh']; //给买家收到发货发短信内容
$gateway_1 =$GLOBALS['setting_config']['mjfhjk']; //给买家HTTP_POST接口  
