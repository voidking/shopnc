...
$phone_1=$mj_tel;//买家号码  
$phone_2=$store_info[28];//商家号码 

$user = $GLOBALS['setting_config']['dxuser']; //短信接口账号
$passwd = $GLOBALS['setting_config']['dxmima']; //短信接口密码 
 
$message_mj=$GLOBALS['setting_config']['zfbmj']; //给买家付款成功发短信
$message_sj=$GLOBALS['setting_config']['zfbsj']; //给商家收到付款发短信
	
$gateway_1 =$GLOBALS['setting_config']['zfbmjjk']; //给买家HTTP_POST接口
$gateway_2 = $GLOBALS['setting_config']['zfbsjjk']; //给商家HTTP_POST接口
...
$message_sj=$GLOBALS['setting_config']['xxsjdx']; //给商家收到付款发短信  
$gateway_2 = $GLOBALS['setting_config']['xxsjdxjk']; //给商家HTTP_POST接口  
...
$message_mj=$GLOBALS['setting_config']['yfkmj']; //给买家付款成功发短信
$message_sj=$GLOBALS['setting_config']['yfksj']; //给商家收到付款发短信
	
$gateway_1 =$GLOBALS['setting_config']['yfkmjjk']; //给买家HTTP_POST接口
$gateway_2 = $GLOBALS['setting_config']['yfksjjk']; //给商家HTTP_POST接口
