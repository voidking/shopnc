...
class BaseStoreControl{
     ...
     * 取所有分类名称
     */
    public function getAllCategoryET() {
        Language::read('store_goods_index,home_layout,home_category_index');
        Tpl::output('AllCategory', F('goods_class') ? F('goods_class') : H('goods_class', true, 'file'));
    }
	//文章输出
	private function _article() {
