...
$lang['open_rewrite_tips']                  = '启用伪静态可以提高搜索引擎抓取<br/>如果您使用的是Apache服务器，启用前，请先确保已开启apache服务器的rewrite.module功能模块，并将商城目录下的"htaccess.txt"文件重命名为".htaccess"。<br/>如果您使用的是IIS服务器，启用前，请确保已正确安装ISAPI_Rewrite，并将商城目录下的"htaccess.txt"文件重命名为".htaccess"，<br/>如果您使用的是Nginx服务器，启用前，请将htaccess.txt内的nginx版伪静态规则复制到nginx.conf中，然后重启nginx。';
...
$lang['member_logo_notice']                 = '默认为网站Logo，在会员中心头部显示，建议使用240px * 60px';
...
$lang['site_phone_notice']                  = '前台商家中心页面右下侧可以显示，方便卖家遇到问题时咨询，多个请用半角逗号 "," 隔开';
$lang['site_email']                         = '电子邮件';
$lang['site_email_notice']                  = '前台商家中心页面右下侧可以显示，方便卖家遇到问题时咨询';
