...
$lang['web_config_edit_help3']			= '中部的“商品推荐模块”由于页面宽度只能加4个，商品数为8个；右侧的排行个数为7个；底部的品牌最多为10个(已选择的可以拖动进行排序，单击选中，双击删除)。';
...
$lang['web_config_upload_tit_tips']			= '建议上传212*45像素GIF\JPG\PNG格式图片，超出规定范围的图片部分将被自动隐藏。';
...
$lang['web_config_upload_act_tips']			= '建议上传212*280像素GIF\JPG\PNG格式图片，超出规定范围的图片部分将被自动隐藏。';
$lang['web_config_upload_act_url']			= '输入点击该图片后所要跳转的链接地址。';
$lang['web_config_upload_act_adv']			= '调用条件为：已启用、宽度212像素、高度280像素、图片类广告。';
...
$lang['web_config_upload_pic_tips']			= '建议上传212*241像素GIF\JPG\PNG格式图片，超出规定范围的图片部分将被自动隐藏。';
$lang['web_config_upload_adv_url']			= '广告跳转链接';
$lang['web_config_upload_pic_url_tips']			= '输入点击该图片后所要跳转的链接地址';
$lang['web_config_adv_url_tips']			= '调用条件为：已启用、宽度212像素、高度241像素、幻灯片类广告。';