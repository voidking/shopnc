...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['basic_info'];?></span></a></li>
        ...
        <li><a href="index.php?act=setting&op=duanxin_setting"><span>短信接口设置</span></a></li>
      </ul>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo TEMPLATES_PATH;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo SiteUrl.'/'.(ATTACH_COMMON.DS.$output['list_setting']['site_logo']);?>"></div>
          ...
          <td class="vatop tips"><span class="vatop rowform">240px * 60px</span></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo TEMPLATES_PATH;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo SiteUrl.'/'.(ATTACH_COMMON.DS.$output['list_setting']['member_logo']);?>"></div>
