  ...
  <form id="adv_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2" id="main_table">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label for="adv_bgcolor">背景颜色</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
          <input type="text" name="adv_bgcolor" id="adv_bgcolor" class="color {hash:true}" value="<?php echo $v['adv_bgcolor']; ?>"></td>
          <td class="vatop tips">如上传的图片小于规定的图片大小，可用相似的背景色填充</td>
        </tr>
      </tbody>
      <tbody id="adv_pic">
        <tr>
      ...
      <tbody id="adv_slide_pic">
        <tr>
          <td colspan="2" class="required"><label for="file_adv_slide_pic"><?php echo $lang['adv_slide_upload'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-box">
      ...
      <tbody id="adv_slide_url">
        <tr>
          <td colspan="2" class="required"><label for="type_adv_slide_url"><?php echo $lang['adv_url'];?>: </label></td>
        </tr>
        <tr class="noborder">
      ...
      <tbody id="adv_slide_sort">
        <tr>
          <td colspan="2" class="required"><label class="validation"for="type_adv_slide_sort"><?php echo $lang['adv_slide_sort'];?>:</label></td>
        </tr>
        <tr class="noborder">
