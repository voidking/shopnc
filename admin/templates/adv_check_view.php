...
<div class="page">
  ...
  <table class="table tb-type2 nobdb" id="main_table">
    <tbody>
     ...
     <!-- <tr>
        <td colspan="2" class="required">背景颜色:</td>
      </tr>
      <tr class="noborder">
        <td class="vatop rowform"><input type="text" name="adv_bgcolor" id="adv_adv_bgcolor" class="color {hash:true}" value="<?php echo $v['adv_bgcolor']; ?>"></td></td>
        <td class="vatop tips"></td>
      </tr>-->
      <?php 
