    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          ...
          <td class="vatop tips">如果短信通知请填写：邮箱</td>
        </tr>
    <!--首次注册手机号control\member.php里面也要增加保存字段代码mr.ppx-->
    <tr>
          <td colspan="2" class="required"><label class="validation" for="member_mobile">首次注册手机号:</label></td>
        </tr>
        <tr class="noborder">
          ...
          <td class="vatop tips"><?php echo $lang['member_index_mobile']?></td>
        </tr>
    <!--首次注册手机号-->
        <tr>
