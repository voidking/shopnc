  ...
  <form id="adv_form" enctype="multipart/form-data" method="post" name="advForm">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label for="adv_adv_adv_bgcolor">背景颜色</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform">
          <input type="text" name="adv_bgcolor" id="adv_adv_bgcolor" class="color {hash:true}" value="<?php echo $v['adv_bgcolor']; ?>"></td>
          <td class="vatop tips"></td>
        </tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo TEMPLATES_PATH;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo SiteUrl."/".ATTACH_ADV."/".$pic;?>" onload="javascript:DrawImage(this,500,500);"></div>
        ...
        <?php break; case '2': $pic_content = unserialize($v['adv_content']); $pic = $pic_content['adv_slide_pic'];  $url = $pic_content['adv_slide_url']; ?>
        <tr id="adv_slide_pic" >
          <input type="hidden" name="mark" value="2">
          <td colspan="2" class="required"><label class="file_adv_slide_pic"><?php echo $lang['adv_slide_upload'];?>:</label></td>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo TEMPLATES_PATH;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo SiteUrl."/".ATTACH_ADV."/".$pic;?>" onload="javascript:DrawImage(this,500,500);"></div>
            </span> <span class="type-file-box">
        ...
        <tr id="adv_slide_url">
          <td colspan="2" class="required"><label for="adv_slide_url"><?php echo $lang['adv_url'];?>:</label></td>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="adv_slide_url" id="adv_slide_url" class="txt" value="<?php echo $url; ?>"></td>
          <td class="vatop tips"><?php echo $lang['adv_url_donotadd'];?></td>
        </tr>
        <tr id="adv_slide_sort">
          <td colspan="2" class="required"><label for="adv_slide_sort"><?php echo $lang['adv_slide_sort'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="adv_slide_sort" id="adv_slide_sort" class="txt" value="<?php echo $v['slide_sort']; ?>"></td>
          <td class="vatop tips"><?php echo $lang['adv_slide_sort_role'];?></td>
        </tr>
...
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/swfobject_modified.js" charset="utf-8"></script> 
<script type="text/javascript">
$(function(){
