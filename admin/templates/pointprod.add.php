...
<div class="page">
  ...
  <form id="pointprod_form" method="post" enctype="multipart/form-data" >
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        <tr>
          <th class="required" style="line-height:normal; border-top: 1px dotted #CBE9F3;"><label for=""><?php echo $lang['admin_pointprod_goods_image'];?>:</label>建议使用400*400的图片</th>
          <td colspan="2" class="required"><label class="validation" for="goodsname"><?php echo $lang['admin_pointprod_goods_name']; ?>:</label></td>
        </tr>
        <tr class="noborder">
          <th rowspan="6" class="picture"><div class="size-200x200"><span class="thumb size-200x200"><i></i><img src="<?php echo SiteUrl.DS.ATTACH_COMMON.DS.C('default_goods_image'); ?>" onload="javascript:DrawImage(this,200,200);" nc_type="goods_image" /></span></div>
          </th>
      ...
      <tbody>
        <tr>
          <td colspan="3" class="required"><label><?php echo $lang['admin_pointprod_freightcharge']; ?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="radio" name="freightcharge" id="freightcharge_0" value="0" checked="checked" onclick="showfreightcharge();"/>
            &nbsp;<?php echo $lang['admin_pointprod_freightcharge_saler']; ?>&nbsp;
            <input type="radio" name="freightcharge" id="freightcharge_1" value="1" onclick="showfreightcharge();"/>
            &nbsp;<?php echo $lang['admin_pointprod_freightcharge_buyer']; ?></td>
          <td colspan="2" class="vatop tips"></td>
        </tr>
      </tbody>
      <tbody id="freightcharge_div">
        <tr class="noborder">
          <td colspan="3" class="required"><label for="freightprice" class="validation"><?php echo $lang['admin_pointprod_freightprice']; ?>: </label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><ul id="divUploadTypeContainer">
              <li>
                ...
                <label for="bat_upload"><?php echo $lang['admin_pointprod_uploadimg_more'];?></label>
              </li>
              <li>
                <input name="upload_types" id="com_upload" type="radio" value="com_upload" />
                <label for="com_upload"><?php echo $lang['admin_pointprod_uploadimg_common'];?></label>
              </li>
            </ul></td>
          <td colspan="2" class="vatop tips"></td>
        </tr>
        ...
        <tr class="noborder">
          <td colspan="3"><ul id="thumbnails" class="thumblists">
              ...
              <li id="<?php echo $v['upload_id'];?>" class="picture" >
                ...
                <p><span><a href="javascript:insert_editor('<?php echo $v['upload_path'];?>');"><?php echo $lang['nc_insert'];?></a></span><span><a href="javascript:del_file_upload('<?php echo $v['upload_id'];?>');"><?php echo $lang['nc_del'];?></a></span></p>
              </li>
              <?php } ?>
              <?php } ?>
            </ul></td>
...
$(function(){
    ...
    $('#pointprod_form').validate({
        ...
        messages : {
            ...
            freightprice : {
				required: '<?php echo $lang['admin_pointprod_add_freightprice_null_error']; ?>',
				number  : '<?php echo $lang['admin_pointprod_add_freightprice_number_error']; ?>',
				min     : '<?php echo $lang['admin_pointprod_add_freightprice_number_error']; ?>'
            },
            starttime  : {
    ...
    new SWFUpload({
		...
		button_width: 86,
		button_height: 18,
		button_text: '<span class="button"><?php echo $lang['admin_pointprod_uploadimg_more'];?></span>',
...
function add_uploadedfile(file_data)
{
    ...
    var newImg = '<li id="' + file_data.file_id + '" class="picture"><input type="hidden" name="file_id[]" value="' + file_data.file_id + '" /><div class="size-64x64"><span class="thumb"><i></i><img src="<?php echo SiteUrl.'/'.ATTACH_POINTPROD.'/';?>' + file_data.file_name + '" alt="' + file_data.file_name + '" width="64px" height="64px"/></span></div><p><span><a href="javascript:insert_editor(\'<?php echo SiteUrl.'/'.ATTACH_POINTPROD.'/';?>' + file_data.file_name + '\');"><?php echo $lang['admin_pointprod_uploadimg_add'];?></a></span><span><a href="javascript:del_file_upload(' + file_data.file_id + ');"><?php echo $lang['nc_del'];?></a></span></p></li>';
