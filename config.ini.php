...
//网站地址，最后不要斜杠
$config['site_url'] = 'http://shopnc.dev';

//版本号
$config['version'] = '20130705';

//安装日期
$config['setup_date'] = '2017-08-14 10:40:18';
...
$config['db'][1]['dbuser']  	= 'root';
$config['db'][1]['dbpwd'] 	 	= '';
$config['db'][1]['dbname']  	= 'shopnc';                  //在设置主从服务器部署或者使用pdo时，该项均必须填写正确且所有服务器的数据库名须与此设置相同！
$config['db'][1]['dbcharset']   = 'UTF-8';
