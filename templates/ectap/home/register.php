...
<html>
    ...
    <body>
        ...
        <section class="login-form section-box">
            <form method="post" action="<?php echo SiteUrl;?>/index.php?act=login&op=usersave">
                ...
                <div class="login-input">
                    <label class="input-label input-label-username"></label>
                    <input id="email" name="email" type="text" class="input-text username" placeholder="邮&nbsp;&nbsp;&nbsp;&nbsp;箱">
                </div>
                <div class="login-input">
                ...
                <div class="login-input">
                    <label class="input-label input-label-password"></label>
                    <input id="password_confirm" name="password_confirm" type="password" class="input-text password" placeholder="确认密码">
                </div>
                <div class="login-input">
