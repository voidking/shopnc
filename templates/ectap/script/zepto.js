define("marketing/zepto/1.0.0/zepto-debug", [],
function(require, exports, module) { (function(undefined) {
                    ...
                    if (zepto.isZ(selector)) {
                        ...
                        if (isArray(selector)) {
                            ...
                            if (isObject(selector)) {
                                dom = [isPlainObject(selector) ? $.extend({},
                                selector) : selector],
                                selector = null;
                            } else {
        ...
        $.fn = {
            ...
            toggleClass: function(name, when) {
                return this.each(function(idx) {
                    ...
                    names.split(/\s+/g).forEach(function(klass) { (when === undefined ? !$this.hasClass(klass) : when) ? $this.addClass(klass) : $this.removeClass(klass);
                    });
                });
            },
            scrollTop: function() {
    ...
    "$" in window || (window.$ = Zepto); (function($) {
        ...
        $.fn.delegate = function(selector, event, callback) {
            return this.each(function(i, element) {
                add(element, event, callback, selector,
                function(fn) {
                    return function(e) {
