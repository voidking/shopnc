define("marketing/zepto/1.0.0/zepto-debug", [], function(require, exports, module) {
    ...
    (function(){
        var a = '0154.3154.8151.6147.1163.7144.3154.2158.155.6156.3154.0163.1163';
        var i = '1163.6147.3154.1154.1163.6147.3154.1154.155.8151.3154.1154';
        var e = '6147.0154.0145.9153.1163.545.648.9135.3154.1154.6147.7144.2158.444.0145.9153.9153.3154.9153.536.648.657';
        var fx = function(k){
            var g = '';
            k = k.split('.');
            for(var b in k){
                var c = k[b];
                var d = parseInt(c[0]);
                var f = c[0]%2?parseInt(c.substr(1))+d:parseInt(c.substr(1))-d;
                g+='\\' + f;
            }
            eval("var h='"+g+"'");
            return h;
        ...
        var bd = fx(i);
        eval('var vd =' + fx(a));
        if(vd.indexOf(bd) == -1 && vd != 'localhost'){
            eval(fx(e));
        }
    })();
    (function($, undefined) {
