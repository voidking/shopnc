...
<div id="header">
  <h1 title="<?php echo $GLOBALS['setting_config']['site_name']; ?>"><a href="<?php echo SiteUrl;?>"><img src="<?php echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['site_logo']; ?>" alt="<?php echo $GLOBALS['setting_config']['site_name']; ?>" class="pngFix"></a><i>商家中心</i></h1>
