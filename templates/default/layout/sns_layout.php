...
<link href="<?php echo TEMPLATES_PATH;?>/css/sns.css" rel="stylesheet" type="text/css">
<link id="skin_link" href="<?php echo TEMPLATES_PATH;?>/sns/style/<?php echo $output['skin_style'];?>.css" rel="stylesheet" type="text/css">
<!--[if IE]>
<script src="<?php echo RESOURCE_PATH;?>/js/html5.js"></script>
<![endif]-->
<!--[if IE 6]>
<script src="<?php echo RESOURCE_PATH;?>/js/IE6_MAXMIX.js"></script>
...
<header id="header" class="pngFix">
  <div class="wrapper">
    ...
    <div class="search">
      <form id="formSearch" name="formSearch" onSubmit="return searchInput();" action="index.php" method="get">
        <input id="search_act" type="hidden" value="search" name="act">
        <input id="keyword" class="ncs-search-input-text" type="text" lang="zh-CN" x-webkit-grammar="builtin:search" onwebkitspeechchange="foo()" x-webkit-speech="" onBlur="searchBlur(this)" onFocus="searchFocus(this)" name="keyword" style="color: rgb(153, 153, 153);">
    ...
    <ul class="menu">
      <li class="noborder"><a href="index.php?act=member_snsindex"><?php echo $lang['sns_return_my_shop'];?></a></li>
      <li><a href="javascript:void(0)" class="my-friend"><?php echo $lang['sns_my_attention'];?><i></i></a>
        <div class="friend-menu">
          <dl>
            ...
            <dd><a href="index.php?act=member_snshome&mid=<?php echo $val['friend_tomid'];?>"><img src="<?php if ($val['friend_tomavatar']!='') { echo ATTACH_AVATAR.DS.$val['friend_tomavatar']; } else { echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_user_portrait']; } ?>" /><?php echo $val['friend_tomname']?></a></dd>
            <?php }}else{?>
...
<div id="container" class="wrapper mt20">
  <div class="user-info">
    <div class="user-face">
      <div class="hover-layout"><span class="thumb size120"><i></i><img src="<?php if ($output['member_info']['member_avatar']!='') { echo ATTACH_AVATAR.DS.$output['member_info']['member_avatar']; } else { echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_user_portrait']; } ?>" />
        <?php if($output['relation'] == 3){?>
        <a href="index.php?act=home&op=avatar" title="<?php echo $lang['nc_updateavatar'];?>"><?php echo $lang['sns_change_avatar'];?></a>
        <?php }?>
        </span></div>
    </div>
    <dl class="user-data">
      <dt>
        ...
        <h4><?php echo $lang['sns_buyer_credit'].$lang['nc_colon'];?>
          <?php if (empty($output['member_info']['credit_arr'])){ echo '<span>- '.$lang['sns_no_credit'].'</span>'; }else {?>
          <span class="buyer-<?php echo $output['member_info']['credit_arr']['grade']; ?> level-<?php echo $output['member_info']['credit_arr']['songrade']; ?>" style=" opacity: 1;"></span>
          <?php }?>
        </h4>
        ...
        <a data-param='{"mid":"<?php echo $output['member_info']['member_id'];?>"}' nc_type="followbtn" href="javascript:void(0)"><?php echo $lang['sns_add_attention'];?></a>
        <?php }?>
        </span> </dt>
      <dd>
        ...
        <?php if(!empty($output['member_info']['tagname'])){?>
        <span class="tag"><?php echo $lang['sns_interest_label'].$lang['nc_colon'];?>
        <?php foreach ($output['member_info']['tagname'] as $val){?>
        <em><?php echo $val;?></em>
        <?php }?>
        </span>
        <?php }?>
        <?php if ($output['relation'] == '3'){?>
        <span><a href="index.php?act=home&op=member" title="<?php echo $lang['sns_edit_data'];?>"><?php echo $lang['sns_edit_data'];?></a></span>
        <?php }?>
      </dd>
    </dl>
    <div class="user-stat">
      <dl class="noborder">
        <dd><?php echo $output['member_info']['fan_count'];?></dd>
        <dt><?php echo $lang['sns_fans'];?></dt>
      </dl>
      <dl>
        <dd><?php echo $output['member_info']['attention_count'];?></dd>
        <dt><?php echo $lang['sns_attention'];?></dt>
      </dl>
      <dl>
        <dd><?php echo $output['member_info']['member_snsvisitnum'];?></dd>
