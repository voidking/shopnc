<div id="page" >
  <div id="zhaitopNav" class="warp-all"  >
    ...
    <ul class="quick-menu" >
      ...
      <li class="cart">
        <div class="menu" ><span class="menu-hd"><s></s><?php echo $lang['nc_cart'];?><strong class="goods_num"><?php echo intval($output['goods_num']); ?></strong><?php echo $lang['nc_kindof_goods'];?><i></i></span>
          <div class="menu-bd" id="top_cartlist"><img class="loading" src="<?php echo TEMPLATES_PATH;?>/images/loading.gif" /></div>
        </div>
      </li>
      <?php }?>
      <!-- 收藏夹 -->
      ...
      <li class="pm"><a href="<?php echo SiteUrl.'/';?>index.php?act=home&op=message" title="<?php echo $lang['nc_message'];?>" target="_top" > <?php echo $lang['nc_message'];?>
		...
		<!--旗下网站-->
		 <li class="qixia">
        <div class="menu"><a class="menu-hd" href="#" title="<?php echo $lang['nc_qixia'];?>" target="_top" ><?php echo $lang['nc_qixia'];?><i></i></a>
          <div class="menu-bd">
            <ul>
              <li><a href="http://115.29.45.198" target="_top" title="微生活社区" >微生活社区</a></li>
