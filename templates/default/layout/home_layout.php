...
<title> <?php echo $output['goods_class_array']['gc_name'];?><?php echo $output['html_title'];?></title>
...
<script src="<?php echo RESOURCE_PATH;?>/new-js/jquery.js" ></script>
<script src="<?php echo RESOURCE_PATH;?>/new-js/jquery.SuperSlide.2.1.1.js" ></script>
<script src="<?php echo RESOURCE_PATH;?>/new-js/common.js"  charset="utf-8"></script>
<script src="<?php echo RESOURCE_PATH;?>/new-js/jquery-ui/jquery.ui.js" ></script>
<script src="<?php echo RESOURCE_PATH;?>/new-js/jquery.validation.min.js" ></script>
<script src="<?php echo RESOURCE_PATH;?>/new-js/jquery.masonry.js" ></script>
<!--[if IE 6]>
<script src="<?php echo RESOURCE_PATH;?>/new-js/IE6_PNG.js" ></script>
<script>
...
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/new-js/IE6_MAXMIX.js"></script> 
<![endif]-->
        ...
        ?>
          <li cat_id="<?php echo $sign;?>" class="<?php if($sign %2==0){?>even<?}else{?>odd<?php }?>" <?php if($sign>8){?>style="display:none;"<?php }?> >
			...
			<span class="ico"><img src="<?php echo SiteUrl.'/'.ATTACH_BRAND.'/'.$val['gc_pic']; ?>"></span>
              ...
              ?>
				<?php 
					...
					foreach(array_slice(explode(',',$output['show_goods_class'][$k]['child']),0,1) as $key){
				?>
                <a href="index.php?act=search&cate_id=<?php echo $key;?>" title="<?php echo trim($output['show_goods_class'][$key]['gc_name'])?>" ><?php echo trim($output['show_goods_class'][$key]['gc_name'])?></a>
                <?php } } ?>
			  <?php } } ?>
			  </span>
			...
			<?php 
              ...
              <dl>
                <dt>
                  <h3><a href="index.php?act=search&cate_id=<?php echo $k;?>" title="<?php echo trim($output['show_goods_class'][$k]['gc_name'])?>" ><?php echo trim($output['show_goods_class'][$k]['gc_name'])?></a></h3>
                </dt>
