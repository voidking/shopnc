          ...
          <div class="nc-bundling-box"> 
            ...
            <div class="nc-bundling-gallery">
              <div class="zoom-section"> 
                <!-- S 默认图片触及显示放大镜效果 -->
                <div class="zoom-small-image"><span class="thumb size360"><a href="<?php echo cthumb($output['bundling_info']['bl_img_more'][0],'max',$output['store_info']['store_id']);?>" class = "nc-zoom" id="zoom1" rel="position: 'inside' , showTitle: false"><img src="<?php echo cthumb($output['bundling_info']['bl_img_more'][0],'mid',$output['store_info']['store_id']);?>" alt="" title=""></a></span></div>
                <!-- S 默认图片触及显示放大镜效果 --> 
                <!-- S 关联默认图片的缩略图 -->
                <nav class="zoom-desc">
                  <ul>
