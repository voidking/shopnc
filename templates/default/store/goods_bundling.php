...
<div class="nc-bundling-container">
  ...
  <div class="nc-bundling-price">
    ...
    <p class="mt5"><a href="index.php?act=bundling&bundling_id=<?php echo $val['id']?>&id=<?php echo $v['store_id'];?>" target="block" class="btn ncs-btn-red"><i class="icon-grid"></i><?php echo $lang['bundling_buy'];?></a></p>
  </div>
  <?php }?>
  <?php }?>
  </div>
