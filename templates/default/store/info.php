...
<div class="ncs-info clearfix">
  ...
  <div class="shop-rate">
    ...
    <dl class="rate">
	  ...
	  <dd class="raty" data-score="<?php echo $output['store_info']['store_desccredit'];?>"></dd>
      <dt><?php echo $lang['nc_service_attitude'];?></dt>
	  <dd class="raty" data-score="<?php echo $output['store_info']['store_servicecredit'];?>"></dd>
      <dt><?php echo $lang['nc_delivery_speed'];?></dt>
	  <dd class="raty" data-score="<?php echo $output['store_info']['store_deliverycredit'];?>"></dd>
    </dl>
  </div>
  ...
  <div class="shop-im">
    ...
    <p>
      ...
      <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=<?php echo $output['store_info']['store_qq'];?>&amp;Site=<?php echo $output['store_info']['store_qq'];?>&amp;Menu=yes" target="_blank"><img src="http://wpa.qq.com/pa?p=2:<?php echo $output['store_info']['store_qq'];?>:51" alt="<?php echo $lang['nc_message_me'];?>"></a>
      <?php }?>
  ...
  <div class="shop-other" id="shop-other">
    <ul>
      <li class="ncs-info-btn-map"><a href="javascript:void(0)" class="pngFix"><span><?php echo $lang['nc_store_map'];?></span><b></b> <!-- 店铺地图 -->
        <div class="ncs-info-map" id="map_container" style="width:198px;height:320px;"><?php echo $lang['nc_map_loading'];?> </div>
        </a></li>
...
$(document).ready(function(){$(".raty").raty({path:"<?php echo RESOURCE_PATH;?>/new-js/jquery.raty/img",hints:['一般', '不错', "很好", '满意', '非常满意'],readOnly:true,width:100,score:function(){return $(this).attr("data-score")}})});
