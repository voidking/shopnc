...
<div class="wrap">
 ...
 ?>    <!-- <dl>
        <dt></em>背景颜色：</dt>
        <dd>
          <input type="text" name="adv_bgcolor" id="adv_bgcolor" class="text  color {hash:true}" value="<?php echo $v['adv_bgcolor']; ?>">&nbsp;&nbsp;<span style="color:#999">(如你选择的是首页大图幻灯片切图片小于1920*481px,请使用相似颜色以填充空白区域)</span></dd>
      </dl>-->
      <dl>
...
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/jscolor.js"></script>
<script type="text/javascript">
	$(function(){
