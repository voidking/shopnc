  ...
  <div class="wrap-all">
    ...
    <div class="ncu-form-style grade-shop">
      <form method="post" enctype="multipart/form-data" id="apply_form" action="index.php?act=member_store&op=save">
        ...
        <dl>
          <dt class="required"><em class="pngFix"></em><?php echo $lang['store_create_address'].$lang['nc_colon'];?></dt>
          <dd>
            <p>
        ...
        <dl>
          <dt class="required"><em class="pngFix"></em><?php echo $lang['store_create_card_no'].$lang['nc_colon'];?></dt>
          <dd>
            <p>
        ...
        <dl>
          <dt class="required"><em class="pngFix"></em><?php echo $lang['store_create_upload_paper'].$lang['nc_colon'];?></dt>
          <dd>
            <p>
