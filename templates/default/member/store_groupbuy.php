  ...
  <table class="ncu-table-style">
    ...
    <tbody>
      <tr class="bd-line"><td></td>
        ...
        <dt><a target="_blank" href="<?php echo ncUrl(array('act'=>'show_groupbuy','op'=>'groupbuy_detail','group_id'=>$group['group_id'],'id'=>$group['store_id']), 'groupbuy');?>"><?php echo $group['group_name'];?></a><a class = "subtitle"target="_blank" href="<?php echo ncUrl(array('act'=>'show_groupbuy','op'=>'groupbuy_detail','group_id'=>$group['group_id'],'id'=>$group['store_id']), 'groupbuy');?>"><?php echo $group['group_subtitle'];?></a></dt></dl></td>
