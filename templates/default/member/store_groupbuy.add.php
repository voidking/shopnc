...
<div class="wrap">
  ...
  <div class="ncu-form-style">
    <form id="add_form" action="index.php?act=store_groupbuy&op=groupbuy_save" method="post" enctype="multipart/form-data">
      ...
      <dl>
        <dt><?php echo '团购副标题'.$lang['nc_colon'];?></dt>
        <dd>
          <p>
            <input class="w400 text" name="input_group_subtitle" type="text" id="input_group_subtitle" value="<?php echo $output['group_info']['group_subtitle'];?>" maxlength="30"  />
            <span></span> </p>
          <span></span>
      ...
      <dl>
        ...
        <dd> <img src="<?php if(empty($output['group_info']['group_pic'])){ echo TEMPLATES_PATH.'/images/transparent.gif';}else{ echo SiteUrl.'/upload/groupbuy/'.$output['group_info']['group_pic'];}?>"  onload="javascript:DrawImage(this,680,350);" nc_type="group_pic" />
          <p>
