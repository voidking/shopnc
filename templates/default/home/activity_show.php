...
<div class="content">
  <div id="banner_box">
    <div class="pic"><img src="<?php if(is_file(BasePath.DS.ATTACH_ACTIVITY.DS.$output['activity']['activity_banner'])){echo SiteUrl."/".ATTACH_ACTIVITY."/".$output['activity']['activity_banner'];}else{echo TEMPLATES_PATH."/images/sale_banner.jpg";}?>" width="1190" height="330" /></div>
    <div class="zs"></div>
