...
<!--左侧-->
  ...
  <div class="right">
    <div class="consume_filter" >
      <div class="consume_filter_line"> <span class="filter_stat"><i class="icon-circle-arrow-right"></i><?php echo $lang['coupon_index_result'];?> <strong><?php echo $output['num']?></strong> <?php echo $lang['coupon_index_num'];?></span>
        <div class="clear"></div>
        <dl>
