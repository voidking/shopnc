...
<link href="<?php echo TEMPLATES_PATH;?>/new-css/home_point.css" rel="stylesheet" type="text/css">
      ...
      <div class="gift_con">
        <div class="giftWare" >
          ...
          <div class="wareInfo">
            <div class="warePic">
              <div class="picFloat">
                <div class="pic"><i></i><a href="<?php echo $output['prodinfo']['pgoods_image']; ?>"><img src="<?php echo $output['prodinfo']['pgoods_image']; ?>" onerror="this.src='<?php echo ATTACH_COMMON.DS.C('default_goods_image')?>'" onload="javascript:DrawImage(this,400,400);"></a></div>
              </div>
            </div>
            <div class="wareText">
              <div class="rate">
