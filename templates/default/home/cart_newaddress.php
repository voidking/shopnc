...
<div>
  ...
  <ul class="fill_in_content">
    ...
    <li>
      ...
      <p class="fill_in">
        ...
        <p class="field_message explain"> <span class="field_notice"><?php echo $lang['cart_step1_telphoneormobile'];?></span>
        <label class="error" generated="true"></label>
        </p> </p>
    </li>
  </ul>
  <div class="clear"></div>
  <div class="submit">
    <button class="btn newaddress-btn" onclick="javascript:submitaddress();"><?php echo $lang['cart_step1_addnewaddress_submit'];?></button>
  </div>
</div>
