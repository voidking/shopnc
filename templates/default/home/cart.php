<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/new-js/goods_cart.js" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/new-js/common_select.js" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/new-js/area_array.js" charset="utf-8"></script>
          ...
          <tbody>
            ...
            <tr id="cart_item_<?php echo $v['spec_id'];?>">
              ...
              <td><a href="JavaScript:void(0);" onclick="decrease_quantity(<?php echo $v['cart_id']; ?>);" title="<?php echo $lang['cart_index_reduse'];?>" class="subtract">&nbsp;</a>
                <input id="input_item_<?php echo $v['cart_id']; ?>" value="<?php echo $v['goods_num']; ?>" orig="<?php echo $v['goods_num']; ?>" changed="<?php echo $v['goods_num']; ?>" onkeyup="change_quantity(<?php echo $v['store_id']; ?>, <?php echo $v['cart_id']; ?>, <?php echo $v['spec_id']; ?>, this);" class="text1  vm" type="text"  style="width:30px; *float: left;text-align: center;"/>
