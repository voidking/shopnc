...
<div class="ncg-container wrapper">
  ...
  <div class="info">
    ...
    <?php } ?>
    <ul>
      <li class="current"><a href="index.php?act=show_groupbuy&op=groupbuy_list"><?php echo $lang['groupbuy_title'];?></a></li>
  ...
  <div class="fenlei">
	...
	<div class="dc"> 
      ...
      <p><i class="icon-chronometer"></i><span id="d1">0</span><strong><?php echo $lang['text_tian'];?></strong><span id="h1">0</span><strong><?php echo $lang['text_hour'];?></strong><span id="m1">0</span><strong><?php echo $lang['text_minute'];?></strong><span id="s1">0</span><strong><?php echo $lang['text_second'];?></strong></p>
  ...
  <div class="group-list">
    <ul>
      ...
      <li class="online">
        <div class="ncg-list-content"> <a title="<?php echo $groupbuy['group_name'];?>" href="<?php echo ncUrl(array('act'=>'show_groupbuy','op'=>'groupbuy_detail','group_id'=>$groupbuy['group_id'],'id'=>$groupbuy['store_id']), 'groupbuy');?>" class="pic-thumb" target="_blank"><img src="<?php echo gthumb($groupbuy['group_pic'],'mid');?>" alt=""></a>
          ...
          <div class="item-prices"> <span class="price"><i><?php echo $lang['currency'];?></i><?php echo $groupbuy['groupbuy_price'];?></span>
            ...
            <span class="sold-num"><em><?php echo $groupbuy['def_quantity']+$groupbuy['virtual_quantity'];?></em>件已购买</span>
			<?php if($groupbuy['state'] == '3') { ?>
			<a href="<?php echo ncUrl(array('act'=>'show_groupbuy','op'=>'groupbuy_detail','group_id'=>$groupbuy['group_id'],'id'=>$groupbuy['store_id']), 'groupbuy');?>" target="_blank" class="buy-button"><?php echo $lang['groupbuy_buy'];?></a>
			<?php } else { ?>
			<a href="<?php echo ncUrl(array('act'=>'show_groupbuy','op'=>'groupbuy_detail','group_id'=>$groupbuy['group_id'],'id'=>$groupbuy['store_id']), 'groupbuy');?>" target="_blank" class="closed-buy-button">已结束</a>
			<?php } ?>
			</div>
        </div>
      </li>
	 ...
	 <?php } else { ?>
  <div class="no-content"><?php echo $lang['no_groupbuy_info'];?>
  </div>
  <?php } ?>
  <?php } else { ?>
  <div class="no-content"><?php echo $lang['no_groupbuy_info'];?>
