        ...
        <dd class="shop-rate" nc_type="shop-rate" store_id='<?php echo $store['store_id'];?>'><?php echo $lang['store_class_index_shop_rate'].$lang['nc_colon'];?><span><i></i></span>
          <div class="shop-rate-con">
              ...
              <dl class="rate">
                  ...
                  <dd class="rate-star"><em><i class="ra" data-score="<?php echo $store['store_desccredit'];?>"></i></em><span><?php echo $store['store_desccredit'];?><?php echo $lang['store_class_index_grade'];?></span></dd>
                  <dt><?php echo $lang['store_class_index_service_attitude'].$lang['nc_colon'];?></dt>
                  <dd class="rate-star"><em><i class="ra" data-score="<?php echo $store['store_servicecredit'];?>"></i></em><span><?php echo $store['store_servicecredit'];?><?php echo $lang['store_class_index_grade'];?></span></dd>
                  <dt><?php echo $lang['store_class_index_delivery_speed'].$lang['nc_colon'];?></dt>
                  <dd class="rate-star"><em><i class="ra" data-score="<?php echo $store['store_deliverycredit'];?>"></i></em><span><?php echo $store['store_deliverycredit'];?><?php echo $lang['store_class_index_grade'];?></span></dd>
              </dl>
          </div>
          </dd>
      </dl>
...
<div class="tc">
<div class="pagination"> <?php echo $output['show_page'];?> </div></div>
</div>
