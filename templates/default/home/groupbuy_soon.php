...
<form id="search_form">
  ...
  <input name="op" type="hidden" value="groupbuy_soon" />
...
<div class="ncg-container wrapper">
  ...
  <div class="info">
    ...
    <ul>
      ...
      <li class="current"><a href="index.php?act=show_groupbuy&op=groupbuy_soon"><?php echo $lang['groupbuy_soon'];?></a></li>
  ...
  <div class="group-list">
    <ul>
      ...
      <li class="soon">
        <div class="ncg-list-content"> <a title="<?php echo $groupbuy['group_name'];?>"href="<?php echo ncUrl(array('act'=>'show_groupbuy','op'=>'groupbuy_detail','group_id'=>$groupbuy['group_id'],'id'=>$groupbuy['store_id']), 'groupbuy');?>" class="pic-thumb" target="_blank"><img src="<?php echo ATTACH_GROUPBUY.'/'.$groupbuy['group_pic'];?>" alt=""></a>
          <h3 class="title"><a title="<?php echo ncUrl(array('act'=>'show_groupbuy','op'=>'groupbuy_detail','group_id'=>$groupbuy['group_id'],'id'=>$groupbuy['store_id']), 'groupbuy');?>" target="_blank"><?php echo $groupbuy['group_name'];?></a></h3>
          ...
          <div class="item-prices"> <span class="price"><i><?php echo $lang['currency'];?></i><?php echo $groupbuy['groupbuy_price'];?></span>
			...
			<span class="sold-num"><em><a href="<?php echo ncUrl(array('act'=>'goods','goods_id'=>$groupbuy['goods_id']), 'goods')?>" target="_blank"><span><?php echo $lang['see_goods'];?></span></a></em></span><a href="<?php echo ncUrl(array('act'=>'show_store','id'=>$groupbuy['store_id']), 'store');?>" target="_blank"class="buy-button"><span><?php echo $lang['see_store'];?></span></a>
            </div>
        </div>
      </li>
      <?php } ?>
	 ...
	 <?php } else { ?>
  <div class="no-content"><?php echo $lang['no_groupbuy_template_soon'];?>
  </div>
  <?php } ?>
  <?php } else { ?>
  <div class="no-content"><?php echo $lang['no_groupbuy_template_soon'];?>
