...
<style type="text/css">
.public-top-layout, .head-search-bar, .search, .head-user-menu, .public-nav-layout, .nch-breadcrumb-layout, #faq ,#footer-top{
    ...
    <div class="nc-login-content" id="demo-form-site">
      <form id="login_form" method="post" class="bg">
        ...
        <dl>
          <dt>&nbsp;</dt>
          <dd>
            <input type="submit" class="submit" value="<?php echo $lang['login_index_login'];?>" name="Submit">
            <a class="forget" href="index.php?act=login&op=forget_password"><?php echo $lang['login_index_forget_password'];?></a><input type="hidden" value="<?php echo $_GET['ref_url']?>" name="ref_url"></dd>
        </dl>
        
      </form>
      <dl class="mt10 mb10">
        <dt>&nbsp;</dt>
        <dd><?php echo $lang['login_index_regist_now_1'];?><a title="" href="index.php?act=login&op=register&ref_url=<?php echo urlencode($output['ref_url']);?>" class="register btn"><?php echo $lang['login_index_regist_now_2'];?></a></dd>
      </dl>
