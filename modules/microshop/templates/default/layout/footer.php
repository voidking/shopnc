...
<div id="footer">
  ...
  Copyright 2007-2013 迈步网络智能科技有限公司 Inc.,All rights reserved.<br />
...
function load_cart_information(){
    $.getJSON('<?php echo SiteUrl;?>/index.php?act=cart&op=ajaxcart&callback=?', function(result){
	    if(result){
	        var result  = result;
...
function drop_topcart_item(store_id, spec_id){
    ...
    $.getJSON('<?php echo SiteUrl;?>index.php?act=cart&op=drop&specid=' + spec_id + '&storeid=' + store_id, function(result){
        if(result.done){
            //删除成功
...
<!--百度分享-->
<script>window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"","bdStyle":"0","bdSize":"16"},"slide":{"type":"slide","bdImg":"4","bdPos":"right","bdTop":"263"},"image":{"viewList":["qzone","tsina","tqq","renren","t163"],"viewText":"分享到：","viewSize":"16"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tsina","tqq","renren","t163"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=86835285.js?cdnversion='+~(-new Date()/36e5)];</script>
</body>
</html>
