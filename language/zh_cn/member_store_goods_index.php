...
$lang['store_goods_step2_spec_img_help']				= '支持jpg、jpeg、gif、png格式图片。<br />建议上传尺寸360x360、大小%.2fM内的图片。<br />商品详细页选中颜色图片后，颜色图片将会在商品展示图区域展示。';
$lang['store_goods_step2_description_one']				= '最多可发布5张商品图片。';
$lang['store_goods_step2_description_two']				= '支持图片上传、从用户空间添加两种方式发布。支持jpg、jpeg、gif、png格式图片，建议上传尺寸360x360以上、大小%.2fM内的图片，上传图片将会自动保存在用户图片空间的默认分类中。';
